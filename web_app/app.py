...
def create_pdf(disease, confidence, solution, image, disease_info):
    ...
    pdf.cell(0, 20, "FloraGuard AI - Medical Report", 0, 1, 'C')
                ...
                if result:
                    ...
                    st.markdown(f"""
                        <div class="prediction-card">
                            ...
                            <div class="prediction-label">{disease.replace("___", " - ").replace("_", " ").title()}</div>
                    ...
                    if disease != "background":
                        ...
                        # If not found in DB, construct a RICH temporary object to match the "After Implementation" vision
                        if not disease_info:
                        ...
                        st.download_button(
                            ...
                            data=pdf_bytes,
                            file_name=f"FloraGuard_Report_{datetime.now().strftime('%Y%m%d_%H%M%S')}.pdf",
...
st.markdown("""
    <div style="text-align: center; color: #666; font-size: 0.8rem; margin-top: 2rem;">
        🌿 FloraGuard AI - Powered by TensorFlow Lite & FastAPI
    </div>
""", unsafe_allow_html=True)
